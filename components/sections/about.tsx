export default function About() {
  const paragraphs = [
    "I'm a software engineer passionate about delivering thoughtful, well-designed solutions and applications. I thrive in the space between thorough planning and the careful execution of every feature.",
